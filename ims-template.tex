...
\begin{figure}[tp]
	\centering
		\includegraphics[width=0.8\linewidth]{plots/circstatfig-1.mps}
...
\begin{figure}[tp]
	\centering
		\includegraphics[width=0.8\linewidth]{plots/circstatfigquad-1.mps}
...
\begin{figure}[tp]
	\centering
		\includegraphics[width=0.8\linewidth]{plots/circstatfigcube-1.mps}
