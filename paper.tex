...
A proof of this theorem is given in the next section.  A proofs for the case when $m=0$ was given in~\cite{McKilliam_mean_dir_est_sq_arc_length2010} and for the case when $m=1$ was given in~\cite{McKilliamFrequencyEstimationByPhaseUnwrapping2009}.  The proof here takes a similar approach, but requires new techniques.  %Before giving the proof we make the following remarks.
