...
\begin{tabular}{lrrrrr}
 & LSU & CPF & PHAF & HAF & ZW \\ \toprule
$N=99$ &  &  &  &  & \\ 
$N=199$ & 3 & 1 & 3 & 5 & 23 \\ 
$N=299$ &  &  &  & & \\ 
$N=399$ &  &  &  & & \\ 
$N=499$ &  &  &  & & \\ 
$N\to\infty$ & $-\infty$ & ? & ? & 3.77  & ? \\ \bottomrule
\end{tabular}
\caption{Threshold SNR in decibels for estimators with $m=3$}
\label{tablm3}
\end{table}
