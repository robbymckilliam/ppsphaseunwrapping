...
poly = lambda{ |t| 0.8*t + 0.3 } 
poly2 = lambda{ |t| -0.2*t + 3.3 } 
...
polypic.add_drawable(Draw.new(drawpoly(5.02,0.01, lambda { |t| poly.call(t) })))
polypic.add_drawable(Draw.new(drawpoly(5.02,0.01, lambda { |t| poly2.call(t) })).add_option('dashed evenly'))
drawsamplepoly(5.02,1, lambda { |t| poly.call(t) }, polypic)
drawsamplepoly(5.02,1, lambda { |t| poly2.call(t) }, polypic)
